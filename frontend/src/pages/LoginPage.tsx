...
const LoginPage: React.FC = () => {
  ...
  return (
    <div style={{
      ...
      className="bg-mesh">
      {/* Background orbs */}
      <div style={{ position: 'fixed', top: '15%', left: '10%', width: 400, height: 400, borderRadius: '50%', background: 'radial-gradient(circle, rgba(79,142,247,0.1) 0%, transparent 70%)', pointerEvents: 'none' }} />
      <div style={{ position: 'fixed', bottom: '15%', right: '10%', width: 350, height: 350, borderRadius: '50%', background: 'radial-gradient(circle, rgba(139,92,246,0.1) 0%, transparent 70%)', pointerEvents: 'none' }} />
      ...
      <div style={{ width: '100%', maxWidth: 420, position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <div style={{
            ...
            fontSize: 28, boxShadow: '0 8px 24px rgba(79,142,247,0.4)',
          }}>🧠</div>
        ...
        {/* Card */}
        <div className="card card-glow-blue" style={{ padding: '2rem' }}>
